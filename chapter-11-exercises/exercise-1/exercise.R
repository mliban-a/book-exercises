# Chapter 11 Exercise 1: working with data frames (review)
...
# are represented by the data set, allows us to see inside makes
unique(makes)
length(unique(makes)) # returns the number(length) of makes there are 
